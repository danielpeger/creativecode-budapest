export default function HeroSketch(p) {
  ...
  let imagePath =
    'https://res.cloudinary.com/creativecodebudapest/image/upload/f_auto,dpr_1.0/v1574804898/cc4/creativecode_4_kfila1.jpg';
  let images;
  let colors;
  ...
  p.setup = function () {
    ...
    colors = [p.color('#F27979'), p.color('#F27979'), p.color('#79E6F2')];
    images = [
    ...
    if (useRandomImages) imagePath = images[p.int(p.random(images.length - 1))];
